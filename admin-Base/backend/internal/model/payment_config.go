...
type PaymentConfig struct {
	...
	AppID       int64     `gorm:"index;default:0" json:"appId"`           // 小程序ID，0表示所有小程序
	DramaID     int64     `gorm:"index;default:0" json:"dramaId"`         // 剧集ID，0表示所有剧集
...
type SubscriptionPlan struct {
	ID          int64     `gorm:"primaryKey" json:"id"`
	AppID       int64     `gorm:"index;not null" json:"appId"`                   // 小程序ID
	Period      string    `gorm:"size:32;not null" json:"period"`                // 订阅周期：weekly/monthly/quarterly/yearly
	...
	TierID      string    `gorm:"size:128" json:"tierId"`                        // tier_id
